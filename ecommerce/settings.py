...
SECRET_KEY = 'django-insecure-5jdn6q$&f*@dvm_ww63q#=+60qsiemdh%!ndpss%+54rtyg&pl'
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'loja/templates'],  # adiciona pasta global
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
...
MEDIA_ROOT = BASE_DIR / 'static/imagens'
MEDIA_URL = '/imagens/'
